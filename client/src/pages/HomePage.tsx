  ...
  return (
    <div className="h-full overflow-y-auto">
      <div className="min-h-full flex flex-col items-center justify-center py-16 px-8 text-center">
        <h1 className="text-5xl font-bold text-neutral-900 leading-tight mb-4">
          Your safe space to<br />
          <span className="text-primary-600">practice English</span>
        </h1>
        ...
        <div className="grid grid-cols-3 gap-6 mt-16 max-w-3xl w-full">
          <div className="bg-white rounded-2xl border border-neutral-100 p-6 text-left shadow-sm">
            <div className="w-10 h-10 rounded-xl bg-primary-50 flex items-center justify-center text-primary-600 mb-4">
              <MessageCircle className="w-5 h-5" />
            </div>
            <h3 className="font-semibold text-neutral-900 mb-2">Voice + Text</h3>
          ...
          <div className="bg-white rounded-2xl border border-neutral-100 p-6 text-left shadow-sm">
            ...
            <h3 className="font-semibold text-neutral-900 mb-2">Real Scenarios</h3>
            <p className="text-neutral-500 text-sm">
          ...
          <div className="bg-white rounded-2xl border border-neutral-100 p-6 text-left shadow-sm">
            ...
            <h3 className="font-semibold text-neutral-900 mb-2">Gentle Feedback</h3>
            <p className="text-neutral-500 text-sm">
        ...
        <p className="mt-16 text-xs text-neutral-400 tracking-wider">
